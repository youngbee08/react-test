      ...
      <section className="lg:h-[120vh] md:h-auto h-auto bg-[#F8EFEB] py-5 lg:px-20 md:px-5 px-2">
        ...
        <div className="flex lg:flex-row md:flex-col flex-col relative md:gap-7">
          <div className="lg:w-[50%] md:w-[100%] w-[100%] flex flex-col gap-3">
            <h1 style={{ fontFamily: "Plus Jakarta" }} className="lg:text-3xl md:text-3xl text-4xl font-extrabold my-5">Experience our Unique Approach</h1>
            <p className="text-[18px] italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt dolore sed repellendus laboriosam repudiandae. Deserunt, numquam accusantium</p>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sapiente maxime velit atque fuga ipsum blanditiis cumque provident et accusantium, excepturi officiis autem inventore tempore ut.</p>
            <div className="flex flex-col lg:flex-row md:flex-row gap-3 items-center mt-4">
              <div className="flex flex-col gap-3 p-5 bg-white rounded-2xl shadow transition-transform duration-300 hover:scale-105">
                ...
                <h1 style={{ fontFamily: "Plus Jakarta" }} className="text-2xl">Exceptional Service</h1>
                <p className="text-[15px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio nesciunt excepturi adipisci!</p>
              </div>
              <div className="flex flex-col gap-3 p-5 bg-white rounded-2xl shadow transition-transform duration-300 hover:scale-105">
                <Trophy size={"25px"} color="#E07844"/>
                <h1 style={{ fontFamily: "Plus Jakarta" }} className="text-2xl">Industry Recognition</h1>
                <p className="text-[15px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio nesciunt excepturi adipisci!</p>
              </div>
            </div>
          </div>
          <div className="lg:w-[50%] md:w-[100%] w-[100%] grid grid-cols-12 gap-3 lg:p-5 md:p-5 p-1 mt-10 lg:mt-0 md:mt-6" >
            <img src={assets.showcase3} alt="" className="lg:rounded-2xl   col-span-6  transition-transform duration-300 hover:scale-105"/>
            <img src={assets.showcase8} alt="" className="lg:rounded-2xl    col-span-6  transition-transform duration-300 hover:scale-105"/>
            <img src={assets.showcase6} alt="" className="lg:rounded-2xl   grid col-span-12  transition-transform duration-300 hover:scale-105"/>
          </div>
